...
void ManagerInput::pressKey(unsigned int keyID) { _keyMap[keyID] = true; }

void ManagerInput::releaseKey(unsigned int keyID) { _keyMap[keyID] = false; }

void ManagerInput::setMouseCoords(int x, int y) { _mouseCoords.x = x; _mouseCoords.y = y; }
